        ...
        const user= await prisma.user.findUnique({
            ...
            const promptEnhanceResponse = await openai.chat.completions.create({
                ...
                messages:[
                    {
                        role: 'system',
                        content: `You are a prompt enhancement specialist. Take the user's website request and expand it to a detailed
                        comprehensive prompt that will help create the best possible answer.

                        Enhance this prompt by:
                        1.Adding specific design details (layout, color scheme, typography)
                        2.Specifying key sections and functions.
                        3.Describing the user experience and interactions.
                        4.Including mordern web design best practices.
                        5.Mentioning responsive design requirements.
                        6.Adding any missing but important values.

                        Return ONLY enhanced prompt, nothing else. Make it detailed but concise (2-3 paragraphs max).`
                    },{
                        role: 'user',
                        content: initial_prompt
                    }
            ...
            await prisma.conversation.create({
                data: {
                    role: "assistant",
                    content: 'Website generation completed. You can now view your website and request changes.',
                    projectId: project.id 
                }
            })
...
//controll function to get a single user project
