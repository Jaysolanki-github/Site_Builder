...
const Pricing=() =>{
    ...
    return(
        <>
            <div className='w-full max-w5x1 mx-auto z-20 max-md:px-4 min-h-[80vhv]'>
                <div className='text-center mt-16'>
                    <h2 className='text-gray-100 text-3x1 font-medium'>Choose Your Plan</h2>
                    <p className='text-gray-400 text-sm max-w-md mx-auto mt-2'>Start for free scale up as u grow. Find the perfect plan for your content creation needs</p>
                ...
                <span className='text-white'> Creation / Revision</span> consume
                 <span className='text-white'> 5 credits</span> You can purchase more credits
                to create more projects. </p>
            </div>
            <Footer />
        </>
    )
